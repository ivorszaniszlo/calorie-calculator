...
const StorageCtrl = (function () {
    ...
    return {
        ...
        getItemsFromSelectedStorage: function () {
            let selectedItems;
            // Check if has any items in local storage
        ...
        clearselectedItemFromStorage: function () {
    ...
    return {
        populateItemList: function (items) {
            ...
            items.forEach(function (item) {
                ...
                <strong>${item.name}: </strong> <em>${item.calories} Kalória</em>
        ...
        getSelectedInput: function () {
            return {
                name: StorageCtrl.getItemsFromSelectedStorage().name,
                calories: StorageCtrl.getItemsFromSelectedStorage().calories
            }
        },
        ...
        addListItem: function (item) {
            if (item != undefined) {
                ...
                console.log(li.id);
                // Add HTML
                li.innerHTML = `<strong>${item.name}: </strong> <em>${item.calories} Kalória</em>
                <a href="#" class="secondary-content">
                    <i class="edit-item material-icons">edit</i>
                </a>`;
                // Insert item
        ...
        updateListItem: function (item) {
            ...
            listItems.forEach(function (listItem) {
                ...
                if (itemID === `item-${item.id}`) {
                    document.querySelector(`#${itemID}`).innerHTML = `<strong>${item.name}: </strong> <em>${item.calories} Kalória</em>
                    <a href="#" class="secondary-content">
                        <i class="edit-item material-icons">edit</i>
                    </a>`;
                }
...
const App = (function (ItemCtrl, StorageCtrl, UICtrl) {
    ...
    const itemAddSubmit = function (e) {
        ...
        // console.log(input);  
        // Get selected input from LocalStorage
        const selected = UICtrl.getSelectedInput();
        ...
        } else if (selected.name !== 'undefined' && selected.calories !== 'undefined') {
            // Add item
            const newItem = ItemCtrl.addItem(selected.name, selected.calories);
            // Add item to UI List
            UICtrl.addListItem(newItem);
        } else if (input.name === '' || input.calories === '') {
            const newItem = ItemCtrl.addItem('', 0);
            UICtrl.addListItem(newItem);
        }
        // Get total calories
